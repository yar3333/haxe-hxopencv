...
class Mat
{
	...
	private static var neko_Mat_create = Lib.loadLazy("opencv", "neko_Mat_create", 5);
	
	public function clone() : Mat
	{
		return new Mat(neko_Mat_clone(h));
	}
	private static var neko_Mat_clone = Lib.loadLazy("opencv", "neko_Mat_clone", 1);
	...
	private static var neko_Mat_extractRect = Lib.loadLazy("opencv", "neko_Mat_extractRect", 5);
	
	private function get_rows()
	{
		return neko_Mat_rows(h);
	}
	private static var neko_Mat_rows = Lib.loadLazy("opencv", "neko_Mat_rows", 1);
	
	private function get_cols()
	{
		return neko_Mat_cols(h);
	}
	private static var neko_Mat_cols = Lib.loadLazy("opencv", "neko_Mat_cols", 1);
	
	public function initByArray(arr:Array<Array<Dynamic>>) : Void
	{
		return neko_Mat_initByArray(h, Lib.haxeToNeko(arr));
	}
	private static var neko_Mat_initByArray = Lib.loadLazy("opencv", "neko_Mat_initByArray", 2);
