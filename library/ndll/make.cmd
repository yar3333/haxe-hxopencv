...
SET COMPILER_OPTIONS=/I%INCLUDE_OPENCV% /I%INCLUDE_NEKO% /nologo /W3 /WX- /Od /Oy- /D "WIN32" /D "_WINDOWS" /D "_USRDLL" /D "_WINDLL" /D "_MBCS" /Gm- /EHsc /RTC1 /MTd /GS /Zc:wchar_t /Zc:forScope /Fo%OBJ_DIR%\ /Gd
...
cl %COMPILER_OPTIONS% %SRC_DIR%\*.cpp /link %LINKER_OPTIONS%
GOTO exit
