...
class AnnMlp
{
	...
	private static var neko_AnnMlp_create = Lib.loadLazy("hxOpenCV", "neko_AnnMlp_create", 4);
	...
	private static var neko_AnnMlp_train = Lib.loadLazy("hxOpenCV", "neko_AnnMlp_train", -1);
	
	public function predict(inputs:Mat, outputs:Mat) : Void
	{
		neko_AnnMlp_predict(h, inputs.h, outputs.h);
	}
	private static var neko_AnnMlp_predict = Lib.loadLazy("hxOpenCV", "neko_AnnMlp_predict", 3);
	
	private function getLayerCount() : Int
	{
		return neko_AnnMlp_getLayerCount(h);
	}
	private static var neko_AnnMlp_getLayerCount = Lib.loadLazy("hxOpenCV", "neko_AnnMlp_getLayerCount", 1);
	
	private function getLayerSizes() : Int
	{
		return neko_AnnMlp_getLayerSizes(h);
	}
	private static var neko_AnnMlp_getLayerSizes = Lib.loadLazy("hxOpenCV", "neko_AnnMlp_getLayerSizes", 1);
	
	private function getWeights(layer:Int) : Array<Float>
	{
		return Lib.nekoToHaxe(neko_AnnMlp_getWeights(h, layer));
	}
	private static var neko_AnnMlp_getWeights = Lib.loadLazy("hxOpenCV", "neko_AnnMlp_getWeights", 2);
	...
	private static var neko_AnnMlp_setWeights = Lib.loadLazy("hxOpenCV", "neko_AnnMlp_setWeights", 3);
}
